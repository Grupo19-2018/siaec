...
@NamedQueries({
    ...
    @NamedQuery(name = "Promociones.findByPromocionEstadoActiva", query = "SELECT p FROM Promociones p WHERE p.promocionEstado = :promocionEstado AND p.promocionInicio <= :fechaActual AND p.promocionFin >= :fechaActual"),
